      ...
      onClick={() => {
        if (router.pathname === "/") {
          scroller.scrollTo(name, {
            ...
            offset: name === "projects" ? -20 : (name === "contact" ? 100 : -100)
          });
        } else {
          router.push("/").then(() => {
            scroller.scrollTo(name, {
  ...
  const renderDrawer: () => ReactNode = () => (
    ...
    >
      ...
      <List>
        ...
        <SideBarButton text="Certifications" name="certifications">
          <SchoolIcon />
        </SideBarButton>
        ...
        <SideBarButton text="Testimonials" name="testimonials">
          <StarIcon />
        </SideBarButton>
        <SideBarButton text="Contact me" name="contact">
          <ForumIcon />
        </SideBarButton>
      </List>
    </div>
  ...
  return (
    <>
      <Head>
        ...
        {/* <!-- Primary Meta Tags --> */}
        <meta name="title" content="Soundarya Lahari" />
        <meta
          name="description"
          content="Hi, I am Soundarya Lahari, an adventurer in web development."
          key="description"
        />
        ...
        />
        <meta property="og:title" content="Soundarya Lahari" />
        <meta
        ...
        <meta
          ...
          content={`https://${process.env.NEXT_PUBLIC_VERCEL_URL}`}
        />
        <meta property="twitter:title" content="Soundarya Lahari" />
        <meta
      ...
      <AppBar component="nav">
        <Toolbar>
          ...
          <Typography
            ...
            variant="h6"
          >{`< Soundarya Lahari />`}</Typography>
          {/* </Link> */}
          <div className={classes.navbarRight}>
            <Hidden mdDown>
              <Box mr={2}>
                {NavBarButton("Home", "home")}
                {NavBarButton("Certifications", "certifications")}
                ...
                {NavBarButton("Testimonials", "testimonials")}
