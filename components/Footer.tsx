              ...
              <Grid container className={classes.leftContainer}>
                <Grid item md={6} sm={6} className={classes.iconsGrid}>
                  <Link
                    ...
                    href="https://github.com/soundaryalaharivalipe"
                    target="_blank"
                  ...
                  <Link
                    className={classes.socialItem}
                    href="https://www.linkedin.com/in/soundarya--lahari/"
                    target="_blank"
                    rel="noopener noreferrer"
                    color="inherit"
                  >
                  ...
                  <Link
                    className={classes.socialItem}
                    href="mailto:slahariv@gmail.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    color="inherit"
                  >
                    <MailIcon fontSize="large" className={classes.icon} />
                    <Typography>slahariv@gmail.com</Typography>
                  </Link>
                </Grid>
